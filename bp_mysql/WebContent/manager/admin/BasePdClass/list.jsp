...
<div class="divContent">
  ...
  <form id="listForm" name="listForm" method="post" action="BasePdClass.do?method=delete&pd_class_type=${af.map.pd_class_type}">
    <div style="text-align: left; padding: 5px;">
      <input type="button" name="delete" id="delete" class="bgButton" value="删除所选" onclick="this.form.action += '&' + $('#bottomPageForm').serialize();confirmDeleteAllForClass(this.form);" />
