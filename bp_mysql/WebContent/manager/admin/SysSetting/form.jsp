  ...
  <html-el:form action="/admin/SysSetting">
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableClass">
      ...
      <tr>
        ...
        <td align="left"><html-el:select property="isEnabledCode" styleId="isEnabledCode"style="width:128px;" styleClass="webinput">
      ...
      <tr>
        <td width="15%" class="title_item">是否启用新闻自定义字段：</td>
        <td align="left"><html-el:select property="isEnabledNewsCustomFields" styleId="isEnabledNewsCustomFields"style="width:128px;" styleClass="webinput">
            <html-el:option value="1">启用自定义字段</html-el:option>
            <html-el:option value="0">不启用自定义字段</html-el:option>
          </html-el:select>
          <br />
          启用新闻自定义字段可以实现在新闻管理中随意添加自定义字段</td>
      </tr>
      <tr>
