...
<div class="divContent">
  ...
  <html-el:form action="/admin/BasePdAttribute" enctype="multipart/form-data">
    ...
    <html-el:hidden property="cls_id" styleId="cls_id" value="${basePdClass.cls_id}"/>
    <html-el:hidden property="pd_class_type" styleId="pd_class_type" value="${pd_class_type}"/>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClassTbody">
      ...
      <c:if test="${not empty basePdClass}">
        <tr>
          <td width="12%" nowrap="nowrap" class="title_item">绑定类别名称：</td>
          <td width="88%"><c:out value="${basePdClass.cls_name}"></c:out></td>
        </tr>
      </c:if>
      <tr>
      ...
      <tr>
        <td colspan="2" align="center"><html-el:button property="" value="保 存" styleClass="bgButton" styleId="btn_submit" />
          ...
          <c:if test="${not empty basePdClass}"> &nbsp; <span style="color: #F00;">此属性保存后会直接绑定到${basePdClass.cls_name}</span> </c:if></td>
      </tr>
