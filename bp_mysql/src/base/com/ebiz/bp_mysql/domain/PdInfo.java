...
public class PdInfo extends BaseDomain implements Serializable {
	...
	public void setPd_class_type(Integer pd_class_type) {
		this.pd_class_type = pd_class_type;
	}
	...
	public Integer getOrder_min_num() {
		return order_min_num;
	}

	public void setOrder_min_num(Integer order_min_num) {
